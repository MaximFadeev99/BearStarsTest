...
namespace BearStarsTest.Utilities
{
    ...
    {
        private readonly List<T> _allElements = new List<T>();
        ...
        {
            if (_allElements.Contains(elementToRemove))
                _allElements.Remove(elementToRemove);
